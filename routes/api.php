...
// CMS / Content Pages (no auth required)
...
// ─── Sanctum-Protected User Panel Routes ─────────────────────
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('manual-purchase', [OrderController::class, 'manualPurchase']);
