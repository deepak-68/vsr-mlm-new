...
class AccessibilityController extends Controller
{
    ...
    {
        $AccessibilityContent = Accessibility::firstOrCreate(
            [],
            [
        ...
        return view('admin.pages.admin-accessibility', compact('AccessibilityContent'));
    }

    public function update(Request $request)
    {
        $AccessibilityContent = Accessibility::firstOrFail();
        ...
        $AccessibilityContent->update($data);

        return back()->with('success', 'Accessibility content updated successfully!');
    }
}