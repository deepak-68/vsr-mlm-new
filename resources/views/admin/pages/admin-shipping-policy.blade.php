...
@section("title", "Shipping Policy | Continuity Care")
                    ...
                    <div class="card border shadow-sm h-100">
                        ...
                        <form action="{{ route('admin-shipping-policy.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-header d-flex justify-content-between align-items-center bg-theme-light">
                                <h5 class="mb-0"><i class="fas fa-info-circle"></i>&nbsp; Shipping Policy</h5>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_active" value="1" 
                                        {{ old('is_active', $ShippingContent->is_active) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="sub_title"
                                                ...
                                                value="{{ old('sub_title', $ShippingContent->sub_title) }}" required>
                                            @error('sub_title')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="main_title"
                                                ...
                                                required>{{ old('main_title', $ShippingContent->main_title) }}</textarea>
                                            @error('main_title')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea name="description"
                                                class="form-control summernote">{!! old('description', $ShippingContent->description) !!}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
