...
@section("title", "Cancellation & Refund Policy | Continuity Care")
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card border shadow-sm h-100">
                        ...
                        <form action="{{ route('admin-cancellation-policy.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            
                            <div class="card-header d-flex justify-content-between align-items-center bg-theme-light">
                                <h5 class="mb-0"><i class="fas fa-info-circle"></i>&nbsp; Cancellation & Refund Policy</h5>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_active" value="1" 
                                        {{ old('is_active', $CancellationContent->is_active) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="sub_title"
                                                ...
                                                value="{{ old('sub_title', $CancellationContent->sub_title) }}" required>
                                            @error('sub_title')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="main_title"
                                                ...
                                                required>{{ old('main_title', $CancellationContent->main_title) }}</textarea>
                                            @error('main_title')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea name="description"
                                                class="form-control summernote">{!! old('description', $CancellationContent->description) !!}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
        ...
        <script>
            $(document).ready(function () {
                $('.summernote').summernote({
                    height: 200,
                    placeholder: 'Enter Cancellation & Refund Policy content...'
                });
            });
        </script>
    @endpush
